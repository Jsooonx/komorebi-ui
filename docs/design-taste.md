...
- Components Catalog previews and landing-page Highlights are separate visual surfaces. Highlights own their exclusive Bento implementation, while catalog adapters retain the established component visual and only control catalog-specific sizing, scale, and positioning.
