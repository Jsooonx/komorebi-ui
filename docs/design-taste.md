...
- Preview block containers (such as **Features 1**, **Features 2**, and **Logo Clouds**) are displayed inside scrollable viewports (`h-[580px]` or `h-[650px]`) on the Blocks page.
...
- Layout block headers (like the titles inside **Features 1**, **Features 2**, and **Logo Cloud 3**) are static and scroll away naturally with the layout.
...
### 1. CSS Keyframe Animations vs JS Loops
...
### 4. Seamless Loops (alignment offset)
