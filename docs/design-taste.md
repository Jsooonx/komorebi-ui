...
- Siena uses a compact editorial scroll range with restrained spring smoothing, so the image and type retain a cinematic sense of mass while reduced-motion users stay directly synchronized to scroll.
