...
Features 3 is a minimal six-cell foundation layout with centered typography and tight heading-to-description spacing matching Features 2’s scale, thin dividers, and restrained icons.
