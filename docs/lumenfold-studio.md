...
- Click on the "Menu" button opens a left drawer (occupying 1/3 of the screen width on desktop) with a Work navigation link, contact information, and animated socials. Work links to `#/works` and closes the drawer; the remaining portion of the screen displays a blurred, semi-transparent backdrop. Clicking on the backdrop or the close button also closes the menu drawer. It locks body scroll when open.
