...
`BLOCKS_MANIFEST` contains the 27 layout blocks shown in `/blocks`, including Siena Parallax, Oliver Parallax, Atlas Horizontal Parallax, and Depth Lens Parallax in the Parallax category, four Preloader blocks, three Product Showcase blocks, three Testimonials & Social Proof blocks, plus Plan Lens Pricing and Usage Horizon Pricing in the Pricing & Conversion category. Blocks expose category routes such as `/blocks/parallax`, `/blocks/preloader`, `/blocks/product-showcase`, `/blocks/testimonials`, and `/blocks/pricing`, and each block has a fullscreen page route such as `/blocks/parallax/siena-parallax`, `/blocks/preloader/morphing-lens-preloader`, `/blocks/product-showcase/orbit-workspace-showcase`, `/blocks/testimonials/community-mosaic-testimonials`, or `/blocks/pricing/usage-horizon-pricing`.
