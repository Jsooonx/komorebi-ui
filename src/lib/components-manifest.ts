...
export const BLOCKS_MANIFEST: ComponentManifestItem[] = [
  ...
  {
    id: "stairs-preloader",
    name: "Stairs Preloader",
    category: "Preloader",
    description:
      "A premium preloading layout featuring silver cinematic shimmer text followed by a staggered multi-column stairs wipe animation to reveal the page.",
    dependencies: ["framer-motion"],
    isNew: true,
    gridClass: "md:col-span-2",
    viewportHeightClass: "h-[500px]",
  ...
  {
    id: "version-fold-showcase",
    name: "Version Fold Showcase",
    category: "Product Showcase",
    description:
      "A click-driven release artifact where draft, review, and ready states fold through one stable product record.",
    dependencies: ["framer-motion"],
    isNew: true,
    gridClass: "md:col-span-2 md:row-span-2",
    viewportHeightClass: "h-[500px]",
