  ...
  return (
    <div className="w-full max-w-[1500px] mx-auto h-[820px] flex flex-col rounded-3xl bg-[#080B09] border border-white/10 overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.6),inset_0_1px_0_0_rgba(255,255,255,0.05)] select-none">
            ...
            return (
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-1.5">
                  <FolderOpen
                    className={`w-3.5 h-3.5 transition-colors ${isActive ? "text-sun-gold" : "text-white/25"}`}
                  />
                  <span>{tab.label}</span>
                </span>
              </button>
      ...
      <div className="p-6 relative bg-black/10 flex-grow flex flex-col justify-between overflow-hidden">
        ...
        <span className="absolute top-4 left-4 font-mono text-[12px] text-white/25 z-20 pointer-events-none">
          +
        </span>
        <span className="absolute top-4 right-4 font-mono text-[12px] text-white/25 z-20 pointer-events-none">
          +
        </span>
        <span className="absolute bottom-4 left-4 font-mono text-[12px] text-white/25 z-20 pointer-events-none">
          +
        </span>
        <span className="absolute bottom-4 right-4 font-mono text-[12px] text-white/25 z-20 pointer-events-none">
          +
        </span>
