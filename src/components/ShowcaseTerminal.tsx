          ...
          <div className="flex-grow flex items-center justify-center border border-white/5 bg-black/45 rounded-2xl relative overflow-hidden">
            <AnimatePresence>
              ...
              >
                ...
                {activeTab === "hero" && (
                  <div key={restartKey} className="flex flex-col items-center gap-4 text-center py-12">
                    <RotatingText
                      texts={["Physics-backed motion", "Framer Motion flows", "GSAP micro-interactions", "High performance"]}
                      mainClassName="text-3xl sm:text-4xl md:text-5xl font-serif text-sun-gold justify-center overflow-hidden py-1"
                      staggerFrom="first"
                    ...
                    />
                    <span className="text-[9px] font-mono text-white/30 tracking-widest uppercase mt-4">
