  ...
  return (
    <motion.div 
      ...
      className={`w-full flex items-center justify-between transition-all duration-300 ${
        isMorphed
          ? "max-w-[92%] rounded-2xl bg-black/60 text-white shadow-[0_12px_40px_rgba(0,0,0,0.5)] border border-white/[0.08] backdrop-blur-xl px-5 py-2.5 mt-3"
          : "max-w-full w-full rounded-none bg-[#0c0c0e]/95 text-white border-b border-white/[0.05] backdrop-blur-md px-6 py-3.5 mt-0"
      }`}
    >
      {/* Brand */}
      ...
      <div className="hidden md:flex items-center">
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          .mega-menu-nav-2 [data-state="open"] {
            animation-duration: 200ms !important;
  ...
  if (minimal) {
    return (
      <div 
        ...
        className="w-full h-[400px] border border-white/10 rounded-2xl bg-[#070708] overflow-y-auto scrollbar-none select-none relative"
        style={cssVariables}
      >
