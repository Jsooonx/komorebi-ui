...
export default function HoverExpandVerticalElement() {
  ...
  const items: AccordionItem[] = [
    ...
    },
    {
      ...
      bgClass: "brightness-[0.8] contrast-[1.1] hue-rotate-[200deg] saturate-[2] object-[center_40%]", // blue tone
      renderOverlay: (isExpanded) => (
    ...
    },
    {
      ...
      bgClass: "brightness-[0.7] contrast-[1.3] saturate-[2.5] hue-rotate-[320deg] mix-blend-lighten object-[center_25%]",
      renderOverlay: (isExpanded) => (
      ...
      renderOverlay: (isExpanded) => (
        <div className="absolute inset-x-4 inset-y-0 flex items-center justify-center bg-emerald-950/40 mix-blend-color-burn select-none">
          ...
          <div className="flex gap-4 sm:gap-8 font-serif text-sm sm:text-base text-[#e8ffd0]/85 uppercase font-medium tracking-[0.2em] text-center">
            <span>C</span><span>O</span><span>H</span><span>A</span>
            <span>N</span><span>I</span><span>G</span><span>P</span>
            <span>H</span><span>I</span><span>U</span><span>N</span>
          </div>
        </div>
      ),
    },
    ...
    },
    {
      ...
      renderOverlay: (isExpanded) => (
        <div className="absolute inset-x-4 inset-y-0 flex items-center justify-between select-none">
          ...
          <h5 className="font-serif italic text-xs sm:text-sm text-white/90">
            Prism & refraction
          </h5>
