...
function Index() {
  ...
  useEffect(() => {
    ...
    const onScrollDown = () => window.scrollTo({ top: window.innerHeight, behavior: "smooth" });
      ...
      <div className="hero" ref={heroRef}>
        ...
        <div className="hero__bg">
          <img
            ...
            src="/assets/aura/aura-hero-bg.png"
        ...
        <div className="hero__bottom">
          ...
          <a className="about-card" href="#widget">
            <div className="about-card__image">
              <img src="/assets/aura/aura-about-card.png" alt="Aura AI Conversational Sphere" />
            </div>
